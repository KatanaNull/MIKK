...
public class TriggerComputerInCatitansRoom : MonoBehaviour
{
    ...
    {
        GameManager.triggerComputerInCapitansRoom(true);
    ...
    {
        GameManager.triggerComputerInCapitansRoom(false);
    }
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        {
            if (GameManager._JobComputerInCapitansRoom)
            {
    ...
    {
        GameManager.triggerJobComputerInCapitansRoom(true);
