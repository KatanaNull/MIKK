...
public class TriggerComputerInLabolatory : MonoBehaviour
{
    ...
    {
        GameManager.triggerComputerInLabolatory(true);
    ...
    {
        GameManager.triggerComputerInLabolatory(false);
    }
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        {
            if (GameManager._JobComputerInLabolatory)
            {
    ...
    {
        GameManager.triggerJobComputerInLabolatory(true);
