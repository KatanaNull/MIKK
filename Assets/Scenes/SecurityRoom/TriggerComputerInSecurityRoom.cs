...
public class TriggerComputerInSecurityRoom : MonoBehaviour
{
    ...
    {
        GameManager.triggerComputerInSecurityRoom(true);
    ...
    {
        GameManager.triggerComputerInSecurityRoom(false);
    }
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        {
            if (GameManager._JobComputerInSecurityRoom)
            {
    ...
    {
        GameManager.triggerJobComputerInSecurityRoom(true);
