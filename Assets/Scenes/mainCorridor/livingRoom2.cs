...
public class livingRoom2 : MonoBehaviour
{
    ...
    private void OnTriggerStay()
    {
        ...
        {
            MapManager.DoorLivingRoom2 = new Color(0, 0.22f, 1);
            MapManager.MainCorridor = new Color(1, 1, 1);
            MapManager.LivingRoom2 = new Color(1, 0.4f, 0.4f);
            SceneManager.LoadScene("livingRoom2", LoadSceneMode.Single);
