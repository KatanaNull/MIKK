...
public class TriggerDoorInRoom1 : MonoBehaviour
{
    ...
    private void OnTriggerStay()
    {
        ...
        {
            MapManager.LivingRoom1 = new Color(1, 1, 1);
            MapManager.MainCorridor = new Color(1, 0.4f, 0.4f);
            GameManager.StartPosition(new Vector3(-1.45f, 0.0250001f, -0.3f), 0, 180, 0);
