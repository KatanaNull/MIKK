...
public class TriggerDoorInVehicleEngine : MonoBehaviour
{
    ...
    private void OnTriggerStay()
    {
        ...
        {
            MapManager.VehicleEngine = new Color(1, 1, 1);
            MapManager.MainCorridor = new Color(1, 0.4f, 0.4f);
            GameManager.StartPosition(new Vector3(4.2f, 0.0250001f, 0), 0, 90, 0);
