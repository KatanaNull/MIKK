...
public class TriggerComputerInRoomGG : MonoBehaviour
{
    ...
    {
        GameManager.triggerComputerInRoomGG(true);
    ...
    {
        GameManager.triggerComputerInRoomGG(false);
    }

    public void TrueIdDebug()
    {
        GameManager.triggerJobComputerInRoomGG(true);
